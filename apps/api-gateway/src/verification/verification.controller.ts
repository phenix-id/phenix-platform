  ...
  async webhookProofPresentation(
    ...
    if (
      ...
      await this.marketplaceService
        .recordUsageEvent({
          orgId: proofPresentationPayload.orgId || orgId,
          eventType: 'verification_completed',
          sourceTable: 'presentations',
          sourceId:
            proofPresentationPayload.presentationId ||
            proofPresentationPayload.id ||
            proofPresentationPayload.threadId ||
            `${orgId}:${proofPresentationPayload.createdAt}`,
          occurredAt: proofPresentationPayload.updatedAt || proofPresentationPayload.createdAt,
          quantity: 1,
          metadata: {
            proofId: proofPresentationPayload.id,
