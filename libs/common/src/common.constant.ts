export enum CommonConstants {
  ...
  URL_ISSUE_CREATE_CRED_OFFER_AFJ = '/didcomm/credentials/create-offer',
  // eslint-disable-next-line @typescript-eslint/no-duplicate-enum-values
  URL_ISSUE_GET_CREDS_AFJ = '/didcomm/credentials',
  URL_ISSUE_GET_CREDS_AFJ_BY_CRED_REC_ID = '/didcomm/credentials',
  URL_OUT_OF_BAND_CREDENTIAL_OFFER = '/didcomm/credentials/create-offer-oob',
  URL_ACCEPT_CREDENTIALS = '/didcomm/credentials/accept-offer',
  ...
  URL_SHAGENT_GET_CREATEED_INVITATIONS = '/didcomm/connections',
  URL_SHAGENT_GET_CREATEED_INVITATION_BY_CONNECTIONID = '/didcomm/connections/#',
  URL_SHAGENT_CREATE_OFFER = '/didcomm/credentials/create-offer',
  URL_SHAGENT_CREATE_OFFER_OUT_OF_BAND = '/didcomm/credentials/create-offer-oob',
  URL_SHAGENT_GET_CREDENTIALS = '/didcomm/credentials',
  URL_SHAGENT_GET_CREDENTIALS_BY_CREDENTIAL_ID = '/didcomm/credentials/#',
  URL_SHAGENT_GET_PROOFS = '/didcomm/proofs',
  URL_SHAGENT_GET_PROOFS_BY_PRESENTATION_ID = '/didcomm/proofs/#',
  URL_SHAGENT_REQUEST_PROOF = '/didcomm/proofs/request-proof',
  URL_SHAGENT_ACCEPT_PRESENTATION = '/didcomm/proofs/#/accept-presentation',
  URL_SHAGENT_OUT_OF_BAND_CREATE_REQUEST = '/didcomm/proofs/create-request-oob',
  URL_SHAGENT_PROOF_FORM_DATA = '/didcomm/proofs/#/form-data',
  URL_SHAGENT_ACCEPT_OFFER = '/didcomm/credentials/accept-offer',
  URL_SHAGENT_RECEIVE_INVITATION_URL = '/didcomm/oob/receive-invitation-url',
  URL_SHAGENT_RECEIVE_INVITATION = '/didcomm/oob/receive-invitation',
  URL_SHAGENT_SEND_QUESTION = '/didcomm/question-answer/question/#',
  URL_SHAGENT_SEND_ANSWER = '/didcomm/question-answer/answer/#',
  URL_SHAGENT_QUESTION_ANSWER_RECORD = '/didcomm/question-answer',
  URL_SHAGENT_DELETE_SUB_WALLET = '/multi-tenancy/#',
  URL_SHARED_SEND_BASIC_MESSAGE = '/multi-tenancy/basic-messages/#/@',
  URL_SHAGENT_ACCEPT_PROOF_REQUEST = '/didcomm/proofs/#/accept-request',

  // PROOF SERVICES
  URL_SEND_PROOF_REQUEST = '/didcomm/proofs/request-proof',
  URL_GET_PROOF_PRESENTATIONS = '/didcomm/proofs',
  URL_GET_PROOF_PRESENTATION_BY_ID = '/didcomm/proofs/#',
  URL_VERIFY_PRESENTATION = '/didcomm/proofs/#/accept-presentation',
